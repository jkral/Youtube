...
//  Youtube
//
//  Created by Jeff Kral on 1/14/17.
...
class VideoCell: BaseCell {
    ...
    let thumbnailImageView: CustomImageView = {
        ...
        imageView.image = #imageLiteral(resourceName: "taylorswift")
    ...
    let subtitleTextView: UITextView = {
        ...
        textView.text = "Taylor SwiftVEVO has a lot of views and she is very famous and has lots of boyfriends"
